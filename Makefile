...
INCPATH       = -I. -Iinclude -isystem /usr/include/x86_64-linux-gnu/qt5 -isystem /usr/include/x86_64-linux-gnu/qt5/QtWidgets -isystem /usr/include/x86_64-linux-gnu/qt5/QtGui -isystem /usr/include/x86_64-linux-gnu/qt5/QtNetwork -isystem /usr/include/x86_64-linux-gnu/qt5/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++
...
SOURCES       = main_client.cpp \
		defs/client/clientTest.cpp \
		defs/client/hello.cpp \
		defs/client/window.cpp moc_client.cpp
OBJECTS       = main_client.o \
		clientTest.o \
		hello.o \
		window.o \
		moc_client.o
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		client.pro include/client.h main_client.cpp \
		defs/client/clientTest.cpp \
		defs/client/hello.cpp \
		defs/client/window.cpp
QMAKE_TARGET  = client
DESTDIR       = 
TARGET        = client
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/client.h $(DISTDIR)/
	$(COPY_FILE) --parents main_client.cpp defs/client/clientTest.cpp defs/client/hello.cpp defs/client/window.cpp $(DISTDIR)/
...
main_client.o: main_client.cpp include/client.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main_client.o main_client.cpp

clientTest.o: defs/client/clientTest.cpp include/client.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o clientTest.o defs/client/clientTest.cpp

hello.o: defs/client/hello.cpp include/client.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o hello.o defs/client/hello.cpp

window.o: defs/client/window.cpp include/client.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o window.o defs/client/window.cpp
